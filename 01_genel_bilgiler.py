...
# And, False duyarlidir onu arar buldugu an döndürur.
...
# string değerini [] içinde yazarsak, tek bir eleman olarak alacktır. aynı string'i list() fonksiyonu ile yazarsak da herbir objeyi, 
...
# .append() # listelerin sonuna eleman eklemek için kullanılır, eklenen elemanı hep son sıraya atar. append fonksiyonu içine tek değer yazılmalıdır, aksi takdirde hata verecektir. 
...
# .insert() # listelerin içine değer eklemek için kullanılır, append'den farklı olarak iki değer girilit. ilki değerin atanmak istendiği indeks sırası, 
